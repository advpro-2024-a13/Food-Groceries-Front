...
const ManageSupermarketPage: React.FC = () => {
    ...
    {role === 'ROLE_ADMIN' ? (
      <div style={styles.container}>
        ...
        <div style={styles.buttonContainer}>
          <Link href="/manageSupermarket/create">
            ...
            {filteredSupermarkets.map((supermarket) => (
              <div key={supermarket.supermarketId} style={styles.card}>
                ...
                <div style={styles.buttonGroup}>
                  <Link href={`/manageSupermarket/edit/${supermarket.supermarketId}`}>
...
export default ManageSupermarketPage;
